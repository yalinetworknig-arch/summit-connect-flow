const { Document, Packer, Paragraph, Table, TableRow, TableCell, TextRun, WidthType, BorderStyle, PageOrientation, HeadingLevel, AlignmentType } = require('docx');
const fs = require('fs');
    ...
    children: [
      ...
      new Table({
        ...
        rows: [
          ...
          new TableRow({
            children: [
              new TableCell({ width: { size: 20, type: WidthType.PERCENTAGE }, children: [new Paragraph("8:30 – 9:05 AM")] }),
              new TableCell({ width: { size: 25, type: WidthType.PERCENTAGE }, children: [new Paragraph("National Anthems")] }),
              new TableCell({ width: { size: 55, type: WidthType.PERCENTAGE }, children: [new Paragraph("America & Nigeria")] })
            ]
          }),
          new TableRow({
            children: [
