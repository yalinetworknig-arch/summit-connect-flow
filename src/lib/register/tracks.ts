...
export const TRACKS: Track[] = [
  ...
  { slug: "education", title: "Education & Skills", description: "EdTech, AI literacy, future-of-work skills, and accessible learning at scale.", Icon: GraduationCap },
  { slug: "fintech", title: "FinTech & Digital Finance", description: "Payments, lending, financial access, and Naira-native digital products.", Icon: Landmark },
