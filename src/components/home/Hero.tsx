    ...
    >
      ...
      <div className="relative max-w-[1200px] mx-auto px-6 md:px-12 py-10 md:py-14 min-h-[100dvh] flex flex-col items-center justify-center text-center">
        ...
        <h1 className="sr-only">
          AIDIENGL — Artificial Intelligence, Digital Innovation and Empowering
        ...
        >
          ...
          />
          {/* AIDIENGL Wordmark — white version for dark background, refined shadow */}
          <motion.img
            src={AIDIENGLWhite}
            alt="AIDIENGL — Artificial Intelligence, Digital Innovation, and Empowering the Next Generation of Leaders"
